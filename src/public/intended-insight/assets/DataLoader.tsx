...
export default {
  cdc: {
    ...
    warning:
      "We can't determine the relative risk of contracting COVID-19 from this chart because it doesn't account for vaccination rates in the population.",
    counter:
    ...
    intended:
      'Based on the above, cases may quickly rise following large gatherings.',
    unintended:
      'Based on the above, vaccinated people are more likely to get infected.',
  },
  who: {
    image: who,
    title: '',
    ...
    intended:
      'Based on the above, the vaccine for this season should include both A and B strains of flu as both are common.',
    unintended:
      'Based on the above, flu infections may have been erroneously misclassified as COVID.',
  },
  covidnet: {
    image: covidnet,
    title: '',
    ...
    intended:
      'Based on the above, breakthrough cases become more common as more people get vaccinated.',
    unintended:
      'Based on the above, vaccines may lead to more hospitalizations.',
  },
  wapo: {
    image: wapo,
    title: '',
    ...
    intended:
      'Based on the above, climate has varied a lot over the history of the Earth.',
    unintended:
      'Based on the above, fears of climate change are exaggerated since it has been much hotter before.',
  },
  map: {
    image: map,
    ...
    warning:
      'We cannot determine the relative risk of contracting COVID-19 based on this map, since the data is not normalized by population count.',
    counter:
  ...
  penguins: {
    ...
    intended:
      'Based on the above, we can infer general trends about penguin species from the sample data.',
    unintended:
      'Based on the above, you may mistakenly think these trends apply to all penguins worldwide.',
  },
};
