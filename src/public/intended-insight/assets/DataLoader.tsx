...
export default {
  ...
  who: {
    ...
    warning:
      'Do not make causal conclusions about the patterns in data. There are many factors at play.',
    counter:
  ...
  covidnet: {
    ...
    guide:
      'This chart is from a CDC report on improving how we communicate vaccine effectiveness. As more people get vaccinated, it is expected that cases and hospitalizations among the vaccinated will rise despite no change in vaccine effectiveness. This highlights the need to update public communication on breakthrough cases and emphasize that they are not a reason for panic.',
    intended:
  ...
  wapo: {
    ...
    warning:
      'Zooming out on the entire time series does not reflect the recent trends in climate.',
    counter:
  ...
  map: {
    ...
    counter:
      'The states with highest raw COVID-19 case numbers are predominantly states with higher population counts.',
    guide:
      'This map helps CDC officials and responders quickly identify where case numbers are highest, guiding decisions on deploying medical personnel, scaling up testing, and allocating resources. It’s a tool for prioritizing support where the demand is greatest, ensuring that overwhelmed areas get the assistance they need.',
    intended:
